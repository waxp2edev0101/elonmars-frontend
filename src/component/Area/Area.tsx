...
const Area = ({
  ...
  useEffect(()=>{
    console.log("staked Bird = ", user.stakedBirds);
      ...
      console.log("staked Birds Upated = ",_items);
      setBirds(_items);
  ...
  return (
    ...
    <Box sx={{width:"50%", backgroundColor:mapStatus?"none":"#000000b3", position:"relative"}}>
        ...
        {items.map((item:any, index:number)=>(
            ...
            {item.item === 0 ?
                ...
                : (<Box>
                    ...
                    {/* <img alt="" style={{position:"relative", zIndex: 4}} src={`/images/diamond_${item.item}.png`}/> */}
                    <Box sx={{
                      position:"absolute", 
                      top: `${item.type===3 ?"18px":"26px"}`, 
                      left: `${item.type===3 ?"-14px":"0"}`, 
        ...
        >
            <Box>
              <img alt="" className={styles.item} src={`/images/power_plant.png`}/>
            </Box>
        </Box>}
        ...
        >
            <Box>
              <img alt="" className={styles.item} src={`/images/mine2.png`}/>
            </Box>
        </Box>}
        ...
        >
            <Box>
              <img alt="" className={styles.item} src={`/images/mine1.png`}/>
            </Box>
        </Box>}
    </Box>
  </>
