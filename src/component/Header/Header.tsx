      ...
      <Box className={styles.contents}>
        ...
        <Box className={styles.gbaks} sx={{display:"flex", alignItems:"center"}}>
          ...
          <p className={styles.resource} style={{backgroundColor:"#11dc65", marginLeft:"8px"}}>
            {/* <MonetizationOnIcon/> */}
            <img alt="" style={{width:"25px", marginRight:"10px"}} src="/images/res_gbaks.png"/>
            {`Gbaks: ${userModule.user.gbaks}`}
          </p>
          <p className={styles.resource} style={{backgroundColor:"#ff00da"}}>
            {/* <WidgetsIcon/> */}
            <img alt="" style={{width:"25px", marginRight:"10px"}} src="/images/res_res.png"/>
            {`Res: ${userModule.user.resource}`}
          </p>
          <p className={styles.resource} style={{backgroundColor:"yellow"}}>
            {/* <EggIcon/> */}
            <img alt="" style={{width:"20px", marginRight:"10px"}} src="/images/res_egg.png"/>
            {`Eggs: ${userModule.user.eggs}`}
          </p>
          
          <Button variant="contained" color='secondary' sx={{zIndex:1}} onClick={(e)=>{navigate("/pvp");}}> PvP </Button>
          <Button variant="contained" color='secondary' sx={{ zIndex:1, marginLeft: 1 }} onClick={(e)=>{navigate("/nft");}}> NFT </Button>
