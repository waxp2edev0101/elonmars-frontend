    ...
    <>
      ...
      >
        <Box sx={style}>
            ...
            <Grid item xs={12} sm={6} md={6}>
              <Box sx={{cursor:"pointer"}}>
                ...
                <a href="https://youtu.be/-ZHRm7PzJjY">
                  <img alt="" src="/images/instruction_1.png" style={{width: "280px"}}/>
                </a>
            ...
            <Grid item xs={12} sm={6} md={6}>
              <Box sx={{cursor:"pointer"}}>
                ...
                <a href="https://youtu.be/wjg1JzwjNPk">
                  <img alt="" src="/images/instruction_2.png" style={{width: "280px"}}/>
                </a>
              </Box>
            </Grid>
          ...
          <h1 style={{fontSize: "24px", display:"flex", alignItems:"center"}}><img alt="" src='/images/icon_metamask.png' style={{width: "30px", marginRight: "10px"}}/>Instructions on how to use the metamask for play</h1>
        </Box>
      </Modal>
    </>
  );
